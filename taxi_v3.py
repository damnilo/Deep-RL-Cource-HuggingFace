...
def train(episodes, q_table, max_steps, max_eps, min_eps, eps_decay, lr, env):
...
q_table = train(episodes, q_table, max_steps, max_eps, min_eps, decay_rate, lr, env)
...
push_to_hub(repo_id="damnilo/taxi-v3-q-learning", model=model, env=env, video_fps=1, local_repo_path="hub")